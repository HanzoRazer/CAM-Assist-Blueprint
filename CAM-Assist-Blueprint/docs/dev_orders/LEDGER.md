...
| **A31** | **Pickup Route Strategy Support** | **PR Open** | PR #39 `cursor/cam-a31-pickup-route-strategy-fc97` | `CAM-A31.md` | yes | Capability. First compound operation: 2.5D closed-region pickup cavity, rough → finish. Optional blank_thickness. No G-code. A32 not assigned. Opened 2026-08-30. **Not merged.** |
